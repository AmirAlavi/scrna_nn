...
def pretrain_dense_1136_100_model(model, input_dim, opt, X_orig, working_dir, args):
    ...
    y = X_orig
    h1.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
    ...
    h2.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
...
def pretrain_dense_1136_500_100_model(model, input_dim, opt, X_orig, working_dir, args):
    ...
    # compile and train h2
    h2.compile(loss='mean_squared_error', optimizer=opt)
    h2.fit(X, y, batch_size=int(args.batch_size), epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
    ...
    h3.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
...
def pretrain_ppitf_1136_100_model(model, input_dim, adj_mat, opt, X_orig, working_dir, args):
    ...
    X = X_orig + NOISE_LEVEL * np.random.normal(loc=0, scale=1, size=X_orig.shape)
    y = X_orig
    sparse.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
    ...
    dense.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
...
def pretrain_GOlvls_model(model, input_dim, level1_adj_mat, level2_adj_mat, level3_adj_mat, opt, X_orig, working_dir, args):
    ...
    X = X_orig + NOISE_LEVEL * np.random.normal(loc=0, scale=1, size=X_orig.shape)
    y = X_orig
    level1.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
    ...
    level2.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
    ...
    level3.fit(X, y, batch_size=args.batch_size, epochs=args.epochs, verbose=1, validation_split=args.valid, callbacks=callbacks_list)
